...
export class DeckService {
  private readonly apiUrl = environment.backendApiUrl + '/decks';

  constructor(private readonly http: HttpClient) {}

  // --- API Calls ---

  getDecks(): Observable<ListedDeck[]> {
    return this.http.get<ListedDeck[]>(`${this.apiUrl}`).pipe(catchError(this.handleError));
  }
